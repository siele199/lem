...
try{
 ...
 $query = "SELECT * FROM `rider` WHERE approve ='1'ORDER BY riderid DESC";
 $id = 'riderid';
...
<input type="hidden" name="riderid" value="<?php echo $row['riderid'] ?>">
                 ...
                 <form action="unconfirmrider.php" method="post">
<input type="hidden" name="id" value="<?php echo $row['riderid'] ?>">
                   <th><input type="submit" name="about" class="btn btn-warning" value="Unconfrim" ></th>
