...
$customeruser="SELECT * FROM `order1` WHERE `id`='$iid';";
...
if (isset($_POST['add'])) {
    $updateo = "UPDATE `order1` SET `process`='$status1' WHERE `id`='$iid';";
    ...
    if ($query_run) {
       ...
       $orderider="INSERT INTO `orderdeli`(`orderid`, `customer_user`, `riderid`, `note`, `paymentmode`) VALUES ('$iid','$username','$riderid','$note','$mode');";
    ...
    echo '<script type= "text/javascript">alert("Data Not Updated")</script>'. mysqli_error($connection);
}
?>
<!DOCTYPE html>
