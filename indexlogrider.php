...
$contact= "SELECT * FROM `rider`where username='$username'";
  ...
  <header id="header" class="fixed-top d-flex justify-content-center align-items-center header-transparent">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li><a href="rider_panel.php" data-after="Welcome  <?php echo htmlspecialchars($username) ?>"><?php echo htmlspecialchars($username) ?>'s Profile </a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="box">
              ...
              <div class="btn-wrap">
                <a href="Booking-page.html" class="btn-buy">Book Now</a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
               <div class="row">
                 <?php
while ($row = mysqli_fetch_assoc($contactus)) { ?>
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" value="<?php echo $row['firstname']?>" required>
                </div>
