...
$ride = "SELECT * FROM order1 INNER JOIN users on users.username1=order1.username WHERE process='Completed' AND username='$username'";
...
echo($numb); ?></span></a></li>
          ...
          <li><a class="nav-link scrollto active" href="receipts.php">Reciept</a></li>
    ...
    echo "There are no completed Orders!";
}
...
?><tr>
				...
				<td><?php if ($row['process'] == 'Completed') {
        echo("LEM LaundroMat");
    }
    else {
        echo $row['dop'];
