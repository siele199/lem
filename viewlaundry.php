...

{
  ...
  $sql = "UPDATE `laundryoption` SET  `laundry_title`='$laundrytitle',`laundry_img`='$laundryimg',`laundry_des`='$laundrydes' WHERE `laundryid`='".$laundryid."' ";
...
<html lang="en">
  ...
  <body>
    ...
    <section id="Admin Panel">
      ...
      <form action = "viewlaundry.php" method="post">
              <div class="wrapper">
                  <h2>Admin Panel</h2>
                  <div class="title">
                      Laundry Option
...
?>     
                  <div class="inputfield">
                          <label for="laundryid">LaundryID</label>
                          <input readonly type="text" name="laundryid" class="input" value="<?php echo $row['laundryid']?>">
                      </div>
                <div class="inputfield">
                ...
                <div class="inputfield">
                          <label for="laundryimg">Image Url</label>
                          <input type="text" name="laundryimg" class="input"
                          value="<?php echo $row['laundry_img']?> ">
                      </div>  
                <div class="inputfield">
                          <label for="laundrydes">Description</label>
                          <input type="text" name="laundrydes" class="input"
                          value="<?php echo $row['laundry_des']?> ">
                      </div> 
                      <div class="inputfield">
