...
$username= $_SESSION['username'];
$query = "UPDATE `rider` SET `firstname`='$firstname',`lastname`='$lastname',`password`='$password',`email`='$email',`phno`='$phno',`address`='$address',`pcode`='$postalcode' where `username`= '".$username."' ";
 ...
 <body>
    ...
    >
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="rider_panel_log.php">Rider's Log</a></li>
    ...
    <section id="Registration-Rider">
      ...
      ?>
              ...
              <form action = "rider_panel_log.php"  name = "RegForm" onsubmit = "return validate();"  method="post" enctype="multipart/form-data">     
              ...
              <div class="wrapper">
                  ...
                  <div class="form">
                      ...
                      <div class="inputfield">
                          ...
                          <input readonly type="text" name="nid" class="input"
                          value="<?php echo $row['nationalid']?>">
                      </div>
                      <div class="inputfield">
                          <label for="vehiclereg">Vehicle Registration Number</label>
                          <input readonly type="text" name="vreg" class="input"
                          value="<?php echo $row['vregistration_no']?>">
                      </div>
                     <div class="inputfield">
                          <label for="vehicletype">Vehicle Type</label>
                          <input readonly type="text" name="car" class="input"
