  ...
  <body>
      <header id="header"
          ...
          <nav id="navbar" class="navbar">
              <ul>
                  <li>
                      <a class="nav-link scrollto active" href="index.html #home">Home</a>
                  </li>
                  <li>
                  ...
                  <li class="dropdown">
                      <a href="#"><span>Jobs</span> <i class="bi bi-chevron-down"></i></a>
                      <ul>
                          <li><a href="Be-a-rider-registration.php">Be a Rider</a></li>
                          <li><a href="Login_rider.php">Rider Sign In</a></li>
                      </ul>
                  </li>
                  <li>
      ...
      <section id="Registration-Rider">
          <?php echo $msg; ?>
              <div class="section-title">
               ...
               <form action = "Be-a-rider-registration.php" name = "RegForm" onsubmit = "return validate();"  method="post" enctype="multipart/form-data">    
                  ...
                  <div class="form">
                     ...
                     <div class="inputfield">
                      ...
                      <div class="inputfield">
                         <button type="submit" name="register" value="submit" class="btn">Sign Up Now</button>
                      </div>
                  </div>
