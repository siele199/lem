...
if (isset($_POST['submit'])) {
  ...
  $login_query = "SELECT * FROM `rider` WHERE username='$username' and password='$password'";

  $login_res = mysqli_query($connection, $login_query);
  if (mysqli_num_rows($login_res) > 0) {
    $_SESSION['username'] = $username;
    $_SESSION['status'] = "Active";
    header('Location:indexlogrider.php');
  }
  else {
  ...
  <body>
      ...
      <header id="header"
              ...
              <ul>
                  ...
                  <li><a class="nav-link scrollto" href="index.html #works">How we do it</a></li>
                  <li class="dropdown">
