...
if (isset($_POST['register'])) {
  ...
  try {
    $signup_result = mysqli_query($connection,
      $signup_query);
    if ($signup_result) {
        ...
        <?php echo $msg; ?>
              ...
              <div class="wrapper">
                  ...
                  <div class="title">
                   ...
                   <form action = "addcustomer.php" name = "RegForm" onsubmit = "return validate();"  method="post">
                  <div class="form">
                      ...
                      <div class="inputfield">
                         <button action="Login.php" type="submit" name="register" value="submit" class="btn">Register</button>
                      </div>
                  </div>
                </form>
              </div>
