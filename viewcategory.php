     ...
     <div class="section-title">
      ...
      ?>
                <tr>
                 ...
                 <td><?php echo $row['laundry_img']; ?></td>
                 <td><?php echo $row['laundry_des']; ?></td>       
                       
              <form action="deletea.php" method="post">
<input type="hidden" name="laundryid" value="<?php echo $row['laundryid'] ?>">
                   <th><input type="submit" name="delete" class="btn btn-danger" value="Delete" ></th>

                 </form>
                 <form action="viewlaundry.php" method="post">
<input type="hidden" name="id" value="<?php echo $row['laundryid'] ?>">
                   <th><input type="submit" name="about" class="btn btn-success" value="About" ></th>
                  
                 </form>
                <td> <?php 
                 if($row['status']==1){
                   echo '<p><a href="status.php?laundryid='.$row['laundryid'].'&status=0" class="btn btn-success">Enable</a></p>';
                 }else{
                   echo '<p><a href="status.php?laundryid=' . $row['laundryid'] . '&status=1" class="btn btn-danger">Disable</a></p>';
                 }
                 ?>
                </td>
                </tr>
