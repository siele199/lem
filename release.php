...
$query = "SELECT * FROM orderdeli INNER JOIN rider on rider.riderid=orderdeli.riderid INNER JOIN order1 on order1.id=orderdeli.orderid INNER JOIN users on users.username1=orderdeli.customer_user where rider.available='1' AND order1.delivered='0'";
...
<html lang="en">
  ...
  <body>
    ...
    ; ?></td>
                 ...
                 <form action="released.php" method="post">
<input type="hidden" name="id" value="<?php echo $row["riderid"] ?>"><input type="hidden" name="oid" value="<?php echo $row["orderid"]; ?>">
                   <th><input type="submit" name="release" class="btn btn-success" value="Release" ></th>
