...
try{
 ...
 $query = "SELECT * FROM `rider` WHERE approve ='0'ORDER BY riderid DESC";
 $id = 'riderid';
    ...
    >
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="admin_urider.php">Unapproved Riders</a></li>
...
<input type="hidden" name="riderid" value="<?php echo $row['riderid'] ?>">
                   <th><input type="submit" name="delete" class="btn btn-danger" value="Delete" ></th>

                 </form>
                 <form action="confirmrider.php" method="post">
